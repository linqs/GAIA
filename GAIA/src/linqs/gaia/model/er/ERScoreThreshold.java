...
/**
 * Perform entity resolution by applying simple
 * threshold model where nodes whose similarity
 * is above some specified threshold are predicted co-referent.
 * <p>
 * Note: Implementation and options are based on those for
 * {@link ScoreThreshold}.  This implementation is exactly equivalent
 * to running @{ERLinkPredictor} with {@link ScoreThreshold}
 * as the link predictor.
 * <p>
 * Required Parameters:
 * <UL>
 ...
 * Anything equal to or above the threshold is predicted to be co-referent.
 * Default is .5.
 * <LI> topk-If specified, predict the topk number of values as co-referent regardless of threshold value.
 ...
 *
 */
public class ERScoreThreshold extends BaseConfigurable implements EntityResolution {
	...
	private void initialize(String refschemaid, String edgeschemaid) {
		...
		lp = new ScoreThreshold();
		lp.setCID(this.getCID());
