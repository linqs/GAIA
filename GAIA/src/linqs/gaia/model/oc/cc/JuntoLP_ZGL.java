...
/**
 * Wrapper to the Junto LP_ZGL label propagation algorithm.
 * <p>
 ...
 * Junto method upenn.junto.algorithm.LP_ZGL.Run
 * (See Junto 1.2.2 documentation for details).
 * <UL>
 * <LI> maxIter-Default is 10.
 * <LI> mu2-Default is 10.
 * <LI> keepTopKLabels-Default is 5.
 * <LI> useBipartitieOptimization-Default is "no".
 ...
 *
 */
public class JuntoLP_ZGL extends BaseConfigurable implements Classifier {
	...
	public void predict(Graph testgraph) {
		...
		double mu2 = this.getDoubleParameter("mu2",10);
        int keepTopKLabels = this.getIntegerParameter("keepTopKLabels",5);
		...
		upenn.junto.algorithm.LP_ZGL.Run(junto_g, maxIter, mu2, 
                keepTopKLabels, useBipartiteOptimization, verbose,
                resultList);
