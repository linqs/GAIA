...
/**
 * Wrapper to the Junto QC label propagation algorithm.
 * <p>
 ...
 * Junto method upenn.junto.algorithm.QC.Run
 ...
 *
 */
public class JuntoQC extends BaseConfigurable implements Classifier {
	...
	public void predict(Graph testgraph) {
        ...
        double mu2 = this.getDoubleParameter("mu2", 5);
        double mu3 = this.getDoubleParameter("mu3", 10);
        boolean normalize = this.getYesNoParameter("normalize", "yes");
        ...
        boolean verbose = this.getYesNoParameter("useBipartitieOptimization","no");
        ArrayList<Object> resultList = new ArrayList<Object>();
        
		upenn.junto.algorithm.QC.Run(junto_g, maxIter, mu1, mu2, mu3,
				normalize, keepTopKLabels, useBipartiteOptimization, verbose, resultList);
