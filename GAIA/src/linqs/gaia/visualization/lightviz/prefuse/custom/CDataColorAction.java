...
*/
package linqs.gaia.visualization.lightviz.prefuse.custom;
...
/**
 * <p>
 * Note: This Custom version of a prefuse class was created to allow for
 * a different scale, instead of grayscale, for coloring continuous
 * attributes.
 * </p>
 * 
 * <p>
 ...
 */
public class CDataColorAction extends ColorAction {
     ...
     */
    public CDataColorAction(String group, String dataField,
    ...
    public CDataColorAction(String group, String dataField,
            int dataType, String colorField, int c1, int c2)
    {
        super(group, colorField);
        setDataType(dataType);
        setDataField(dataField);
        m_palette = ColorLib.getInterpolatedPalette(c1, c2);
    }
     ...
     * @throws UnsupportedOperationException {@link #setDefaultColor(int)} not supported
     */
	...
	public void setOrdinalMap(Object[] values) {
        ...
        for ( int i=0; i<values.length; ++i ) {
            m_omap.put(values[i], Integer.valueOf(i));
        }
    }
    ...
    protected int[] createPalette(int size) {
        ...
        default:
        	...
        	return ColorLib.getInterpolatedPalette(size, m_c1, m_c2);
        }
    }
