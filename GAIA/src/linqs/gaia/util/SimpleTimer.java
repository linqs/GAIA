...
/**
 * Simple timer to identify how much time has lapsed. Elapsed time can be return
 * in milliseconds, seconds, minutes, hours or day units
 * 
 * Reference: http://exampledepot.com/egs/java.lang/ElapsedTime.html
 * 
 * @author namatag
 * 
 */
public class SimpleTimer {
     ...
     * If readable==true,
     * "[#days] days [#hours] hours [#mins] mins [#secs] secs [#msecs] msecs".
     * 
     * @param readable
    ...
    /**
     * Return the time since the last time this function was called. The
     * checkpoint time is initialized to the start time.
     * 
     * @return Time elapsed
     */
