...
public class ArrayUtils {
    ...
    /**
     * Return normalized array value (divide the elements with the sum of all elements).
     * 
     * @param array Array of doubles
     * @return Normalized value in array
     */
    public static double[] normalizeValue(double[] array) {
        double[] normArray = array.clone();
        double sum = sum(normArray);
        for (int i = 0; i < array.length; i++) {
    ...
    /**
     * Convert the delimited string into an array of type double. An exception is throw if any
     * delimited portion of the string cannot be cast into a double
     * 
    ...
    /**
     * Return index of the provided value in the array. A -1 is returned if the value is not found
     * in the array.
     * 
    ...
    /**
     * Return a portion of the array. If the start or stop value is outside the range of the array,
     * a null is returned.
     * 
     * @param orig Original array
     * @param startindex Start index to include
     ...
     * 
     * @param array Array whose elements to sum
    ...
    /**
     * Return the proportion of each entry over the full array. (i.e., return an array whose
     * elements are the elements of the original array divided by the sum of the elements).
     * 
     * @param array Array whose elements to normalize
     * @return Proportion of each element
     */
    public static double[] propInArray(double[] array) {
