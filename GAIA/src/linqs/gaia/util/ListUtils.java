...
public class ListUtils {
    ...
    /**
     * Given a list and a number K, we return a new list with K items randomly
     * chosen from the input list.
     * 
     * @param list
     *            List of Items
     * @param K
     ...
     *            List of Items
     * @param randomlist
     *            List to add randomly selected items into
     * @param K
     *            Number of items to pick
     * @param rand
     *            Random number generator
    ...
    public static void pickKAtRandom(List list, List randomlist, int K, Random rand) {
        if (K > list.size() || K <= 0) {
            throw new InvalidOperationException("Invalid value for K: " + K
                    + " given list of size " + list.size());
        }
