...
public class StatisticUtils {
	...
	/**
	 * Get binary confusion matrix.  It will return a confusion matrix in the form
	 * of an integer array of size 4 of form: [true positive, false positive, true negative, false negative]
	 * <p>
	 * Note: The confusion matrix is calculated differently for if the predictions
	 * are positive only (i.e., including only links predicted to be positive instead of all possible links).
	 * 
	 * @param predictions Prediction group
	 * @param truerootvalue Value to set as positive.  All else are considered negative.
	...
	/**
	 * Return confusion matrix for prediction groups which only contains positive predictions
	 * 
	 * @param predictions Prediction group
	 * @param truerootvalue Value to set as positive.  All else are considered negative.
	 * @return Integer array of form [tp,fp,tn,fn]
	 ...
	 * values for the given predictions.  If no specific prediction id is specified,
	 * this will be calculated for all SingleClass predictions.
	 * 
	 * @param predictions List of predictions
	 * @param truerootindex In the set of classes for a single class, which is the true value using one against all.  If set to -1, use the value in the last index.
	 * 
	...
	/**
	 * Returns statistics from the specified set of stats.
	 * The values for each statistics is separated by the provided delimiter.
	 * 
	 * @param stats List of statistics
	 * @param preds Predictions to calculate statistic over
	 * @param delimiter Separator for the values of the different statistics
	...
	/**
	 * Prints the values for the given statistics using the ordering provided
	 * by the header where header is the set of keys for the statistic.
	 * 
	 * @param stats List of statistics
	 * @param preds Predictions to calculate statistic over
	 * @param header List of the statistic keys used to order the results
	 * @param delimiter Separator for the values of the different statistics
	 * @return Separator for the values of the different statistics
	 */
	public static String getStatistics(List<Statistic> stats, PredictionGroup preds,
			List<String> header, String delimiter){
		Map<String,String> allstats = new HashMap<String,String>();
	...
	/**
	 * Given a map containing results for statistics, print the values
	 * in the order of the keys specified in the header.
	 * 
	 * @param allstats Map of statistic values
	 * @param header List of strings representing keys for the statistics
	 ...
	 * @param allstats Map of statistic values
	 * @param header List of strings representing keys for the statistics
	 * @param valdelimiter String delimiter between values
	 * @param keyvaldelimiter String delimiter between key and value
	 * @return String representation of the calculated statistics
	 */
	public static String getStatistics(Map<String,Double> allstats,
	 ...
	 * @param preds Prediction group to use
	 * @param header Header to use printing
	 * @param delimiter Delimiter to separate statistic values
	...
	/**
	 * Get count of a feature.  Whenever the graph item
	 * has a feature value matching the specified true value,
	 * number of positive is incremented.  Otherwise, number of negative is incremented.
	 * An array is returned of the form [number of negative, number of positive].
	 * 
	 * @param gitems Graph Items
	 * @param featurename Name of feature
	 * @param truevalue Value to count as positive
	...
	public static double[] getBinaryCounts(List<GraphItem> gitems,
		...
		return new double[]{numneg,numpos};
	}
	
	/**
	 * List of maps which were returned by getStatisticDoubles fall.
	 * 
	 * @param statmaps List of statistic maps
