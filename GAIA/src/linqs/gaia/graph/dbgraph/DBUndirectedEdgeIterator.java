...
public class DBUndirectedEdgeIterator extends BaseIterator<UndirectedEdge> {
	 ...
	 */
	public DBUndirectedEdgeIterator(DBGraph g, String sql) {
	...
	public UndirectedEdge getNext() {
		...
		try {
			if(rs.next()) {
				...
				if(stype.equals(SchemaType.UNDIRECTED)) {
